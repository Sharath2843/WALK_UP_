...
public class AlarmsListFragment extends Fragment implements OnToggleAlarmListener {
    private com.sif.alarmwalk2wakeup.alarmslist.AlarmRecyclerViewAdapter alarmRecyclerViewAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alarmRecyclerViewAdapter = new com.sif.alarmwalk2wakeup.alarmslist.AlarmRecyclerViewAdapter(this);
